# Hello example for NUCLEO-H563ZI

Simple Hello World example for STMicroelectronics [**NUCLEO-H563ZI**](https://www.st.com/en/evaluation-tools/nucleo-h563zi.html) Discovery kit.
